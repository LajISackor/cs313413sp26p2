...
public class TestList {
  ...
  public void testRemoveObject() {
    ...
    list.add(77);
    list.add(6);
    list.remove(5); // TODO Question: What does this method do? // Answer: Removes index 5 making a new list [3,77,4,77,5,6]
    // TODO fix the expected values in the assertions below
    ...
    assertEquals(77, list.get(3).intValue());
    list.remove(Integer.valueOf(5)); // TODO Question: What does this one do? // Answer: removes the value 5 making the new list [3,77,4,77,6]
